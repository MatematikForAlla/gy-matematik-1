...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.30\linewidth}
    \includegraphics[width=\linewidth]{figs/cykel-FlyingPigeon.jpg}
    \caption{%
      En modern cykel.
  ...
  \hfill
  \begin{subfigure}[t]{0.30\linewidth}
    \includegraphics[width=\linewidth]{figs/cykel-Michaux.jpg}
    \caption{%
  ...
  \hfill
  \begin{subfigure}[t]{0.30\linewidth}
    \includegraphics[width=\linewidth]{figs/cykel-monocycle.jpg}
    \caption{%
      En enhjuling.
    }\label{fig:Enhjuling}
  \end{subfigure}
...
\begin{figure}
  ...
  \includegraphics[width=0.49\linewidth]{figs/cykel-sparkcykel.jpg}
  \caption{%
...
De definitioner vi utgår ifrån behöver inte nödvändigtvis vara principer från 
verkligheten.
